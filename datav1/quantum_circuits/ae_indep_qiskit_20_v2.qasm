...
cry(128*pi) q[8],q[19];
cry(256*pi) q[9],q[19];
cry(512*pi) q[10],q[19];
swap q[8],q[10];
cry(1024*pi) q[11],q[19];
swap q[7],q[11];
cry(2048*pi) q[12],q[19];
swap q[6],q[12];
cry(4096*pi) q[13],q[19];
swap q[5],q[13];
cry(25735.92701820759) q[14],q[19];
swap q[4],q[14];
cry(51471.85403641518) q[15],q[19];
swap q[3],q[15];
cry(102943.70807283036) q[16],q[19];
swap q[2],q[16];
cry(205887.4161456607) q[17],q[19];
swap q[1],q[17];
cry(411774.8322913214) q[18],q[19];
swap q[0],q[18];
h q[0];
cp(-pi/2) q[0],q[1];
cp(-pi/4) q[0],q[2];
