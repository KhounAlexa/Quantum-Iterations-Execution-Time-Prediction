...
cp(768*pi) q[10],q[19];
swap q[8],q[10];
cp(1536*pi) q[11],q[19];
swap q[7],q[11];
cp(3072*pi) q[12],q[19];
swap q[6],q[12];
cp(6144*pi) q[13],q[19];
swap q[5],q[13];
cp(12288*pi) q[14],q[19];
swap q[4],q[14];
cp(24576*pi) q[15],q[19];
swap q[3],q[15];
cp(49152*pi) q[16],q[19];
swap q[2],q[16];
cp(98304*pi) q[17],q[19];
swap q[1],q[17];
cp(196608*pi) q[18],q[19];
swap q[0],q[18];
h q[0];
cp(-pi/2) q[0],q[1];
cp(-pi/4) q[0],q[2];
