...
def main() -> None:
    ...
    parser.add_argument("--results_path", type=str, default=None, help="output results folder")
    ...
    for i in range(10):
        ...
        my_trainer.model.load_state_dict(torch.load(str(parameter_path / "model.pth"), weights_only=True))
        my_trainer.train()
